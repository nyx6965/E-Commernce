...
const getMenProducts = async () => {
  const url = fetch(
    "https://v1-sneakers.p.rapidapi.com/v1/sneakers?limit=20&gender=men&brand=nike%20%2Cvans%2C%20adiddas",
    {
      method: "GET",
      headers: {
  ...
  try {
    ...
    nameProduct.innerHTML = "Men Shoes";
...
const getWomenProducts = async () => {
  const url = fetch(
    "https://v1-sneakers.p.rapidapi.com/v1/sneakers?limit=20&gender=women",
    {
      method: "GET",
      headers: {
        "x-rapidapi-host": "v1-sneakers.p.rapidapi.com",
  ...
  try {
    ...
    nameProduct.innerHTML = "Women Shoes";
    const viewBtns = [...document.querySelectorAll(".view-btn")];
    const viewProducts = () => {
      viewBtns.forEach((button) => {
        button.addEventListener("click", (btn) => {
...
const getChildProducts = async () => {
  const url = fetch(
    "https://v1-sneakers.p.rapidapi.com/v1/sneakers?limit=20&gender=child",
    {
      method: "GET",
      headers: {
        "x-rapidapi-host": "v1-sneakers.p.rapidapi.com",
  ...
  try {
    ...
    nameProduct.innerHTML = "Kids Shoes";
    const viewBtns = [...document.querySelectorAll(".view-btn")];
    const viewProducts = () => {
      viewBtns.forEach((button) => {
        button.addEventListener("click", (btn) => {
...
menShoes.addEventListener("click", getMenProducts);
womenShoes.addEventListener("click", getWomenProducts);
kidsShoes.addEventListener("click", getChildProducts);
